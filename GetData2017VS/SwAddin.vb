...
#Region "UI Methods"
    Public Sub AddCommandMgr()
        ...
        cmdGroup.LargeIconList = iBmp.CreateFileFromResourceBitmap("GetData2017VS.ToolbarLarge.bmp", thisAssembly)
        cmdGroup.SmallIconList = iBmp.CreateFileFromResourceBitmap("GetData2017VS.ToolbarSmall.bmp", thisAssembly)
        cmdGroup.LargeMainIcon = iBmp.CreateFileFromResourceBitmap("GetData2017VS.MainIconLarge.bmp", thisAssembly)
        cmdGroup.SmallMainIcon = iBmp.CreateFileFromResourceBitmap("GetData2017VS.MainIconSmall.bmp", thisAssembly)
